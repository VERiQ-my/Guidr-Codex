...
/**
 * Public marketing landing rendered for signed-out visitors (and crawlers).
 *
 * Deliberately a SERVER component: this is the only content search engines
 * index for guidr.my, so it must arrive as static HTML — no auth, no
 * Firestore, no client JS beyond the CTA button. Copy mirrors the onboarding
 * slides and lib/i18n so marketing claims never drift from what the app says.
 */
...
const copy = {
  en: {
    ...
    features: [
      {
        icon: "users",
        title: "Protect your parents and family",
        body: "Become a guardian for the people you care about and get alerted when someone you protect runs into a risky message.",
      },
      {
        icon: "search",
        title: "A clear answer, not jargon",
        body: "Paste text, upload a screenshot, or take a photo. Guidr tells you if it's safe or not, and explains why in simple words.",
      },
      {
        icon: "bell",
        title: "Stay ahead of active scams",
        body: "Follow scam cases and alerts spreading in Malaysia right now, so you recognise them before they reach you.",
      },
      {
        icon: "lock",
        title: "Private by design",
        body: "Your messages are never stored on our servers. They're checked instantly, then deleted automatically.",
      },
    ],
    ...
    steps: [
      ...
      {
        title: "Share it with Guidr",
        body: "Paste the text, upload a screenshot, or take a photo",
      },
      {
        title: "We tell you if it's safe or not",
        body: "You get a clear answer with a simple explanation",
      },
    ],
    pricing:
      "Guidr is free to use. Guidr Pro unlocks unlimited daily checks and full incident reports.",
    finalCta: "Check your first message",
    metaDescription:
      "Free AI scam checker for Malaysia. Paste a suspicious SMS, WhatsApp message, link or phone number and get a clear answer in seconds.",
  },
  ms: {
    signIn: "Log masuk",
    ...
    features: [
      {
        icon: "users",
        title: "Lindungi ibu bapa dan keluarga anda",
        body: "Jadilah penjaga (guardian) untuk orang tersayang dan terima amaran apabila mereka menerima mesej berisiko.",
      },
      {
        icon: "search",
        title: "Jawapan jelas, bukan istilah teknikal",
        body: "Tampal teks, muat naik tangkapan skrin, atau ambil gambar. Guidr beritahu sama ada ia selamat dan sebabnya, dalam bahasa mudah.",
      },
      {
        icon: "bell",
        title: "Kekal selangkah di hadapan scammer",
        body: "Pantau kes dan amaran penipuan yang sedang tersebar di Malaysia supaya anda mengenalinya sebelum ia sampai kepada anda.",
      },
      {
        icon: "lock",
        title: "Privasi terjamin",
        body: "Mesej anda tidak pernah disimpan pada pelayan kami. Ia disemak serta-merta, kemudian dipadam secara automatik.",
      },
    ],
    ...
    steps: [
      {
        title: "Anda menerima mesej mencurigakan",
        body: "Melalui WhatsApp, SMS, e-mel atau mana-mana aplikasi",
      },
      {
        title: "Kongsikan dengan Guidr",
        body: "Tampal teks, muat naik tangkapan skrin, atau ambil gambar",
      },
      {
        title: "Kami beritahu sama ada ia selamat",
        body: "Anda dapat jawapan jelas dengan penerangan mudah",
      },
    ],
    pricing:
      "Guidr percuma untuk digunakan. Guidr Pro membuka semakan harian tanpa had dan laporan insiden penuh.",
...
/* Inline SVGs keep this component free of client-side icon machinery. */
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between gap-3 px-5 pt-safe-top pb-3 lg:py-4">
          ...
          <nav className="flex items-center gap-4">
            <Link
              ...
              className="text-sm font-medium text-guidr-muted hover:text-guidr-text transition-colors"
            >
              {t.langSwitch.label}
            </Link>
            <Link
              href="/login"
              className="text-sm font-semibold text-guidr-primary hover:underline"
            >
              {t.signIn}
            </Link>
          </nav>
          ...
          <div className="max-w-5xl mx-auto px-5 py-12 lg:py-16">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {t.features.map((f) => (
                <div
                  key={f.title}
                  className="flex items-start gap-4 rounded-2xl p-5 bg-guidr-bg border border-gray-100"
                >
        ...
        <section className="max-w-5xl mx-auto px-5 py-12 lg:py-16">
          ...
          <ol className="grid gap-4 sm:grid-cols-3">
            {t.steps.map((s, i) => (
              <li
                key={s.title}
                className="rounded-2xl p-5 bg-white border border-gray-100 text-center"
              >
