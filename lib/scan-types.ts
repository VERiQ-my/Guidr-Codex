...
export type Analysis = { verdict: Verdict; confidence: number; scam_type: ScamCategory; summary: string; manipulation_tactics: string[]; evidence_chain: string[]; recommended_actions: string[]; assessment_mode?: "ai" | "partial" | "fallback" };
