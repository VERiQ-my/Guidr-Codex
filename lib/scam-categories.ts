interface ScamCategoryDefinition {
  name: string;
  keywords: string[];
}

const CATEGORIES: ScamCategoryDefinition[] = [
...
export type ScamCategory = string;
...
export function displayScamCategory(value?: string) { return normalizeScamType(value); }
